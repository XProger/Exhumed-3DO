...
Object *constructSpider(int sector,int suckParams,MthXyz *pos)
...
{TeleportReturnObject *this=(TeleportReturnObject *)_this;
 switch (msg)
    {case SIGNAL_MOVE:
	assert(this->state==AI_TELEPORTRETURN_TAKEOBJECT);
	this->age++;
	if (this->age==-16)
