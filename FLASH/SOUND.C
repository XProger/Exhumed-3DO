...
enum {S_TRIBAL=2,S_SELKIS,S_SWAMP,S_ROCKIN,S_QUARRY,
	 S_MAGMA,S_KARNAK,S_SANCTUM,S_ENDCREDIT,
	 S_KILMAT1,S_WATER1,S_WATER2,S_MAP};
...
static char trackMap[]={S_KARNAK,S_TRIBAL,S_QUARRY,S_KARNAK,S_SELKIS,
			   ...
			   S_ROCKIN,S_MAGMA,S_QUARRY,S_SWAMP,S_WATER1,
			   S_TRIBAL,S_QUARRY,S_TRIBAL,S_KILMAT1,S_KILMAT1,
			   S_KILMAT1,S_KILMAT1,S_KILMAT1,S_KILMAT1,S_ROCKIN,
			   S_KARNAK};
